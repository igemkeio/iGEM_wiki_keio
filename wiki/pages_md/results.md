<!-- filepath: /home/jiku/dev/repos/example/wiki/pages_md/results.md -->
{% extends "layout.html" %}
  
{% block title %}Results{% endblock %}
{% block lead %}Present the results of your project, along with a detailed analysis and discussion of their significance. Also outline future plans and reflections on the impact of your project.{% endblock %}
