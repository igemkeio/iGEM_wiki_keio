<!-- filepath: /home/jiku/dev/repos/example/wiki/pages_md/safety-and-security.md -->
{% extends "layout.html" %}
  
{% block title %}Safety and Security{% endblock %}
{% block lead %}Detail the safety and security considerations of your project, addressing potential risks and outlining the measures taken to mitigate them.{% endblock %}
