<!-- filepath: /home/jiku/dev/repos/example/wiki/pages_md/members.md -->
{% extends "layout.html" %}

{% block title %}Meet Our Team{% endblock %}
{% block lead %}This page is dedicated to introducing the individuals who made our iGEM project possible. Here, you'll find information about our team members, instructors, and advisors.{% endblock %}
...
> **Important:** Remember that your wiki will be archived and remain publicly accessible. Be mindful of the personal information you share. Avoid posting sensitive details. Be sure everyone shown in pictures agree to them being shown.
